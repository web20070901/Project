...
<div class="main-container" id="main-container">
	...
	<div class="main-container-inner">
		...
		<div class="main-content">
									...
									<table id="sample-table-1" class="table table-striped table-bordered table-hover">
										...
										<c:forEach var="goods" items="${goodsList}">
											<tr>
												...
												<td class="left"><a
														href="http://localhost:8080/fxmall/queryGoodsById?id=${goods.goodId}">${goods.goodName}</a>
												</td>
												...
												<td class="left">
													<div class="visible-md visible-lg hidden-sm hidden-xs btn-group"
														...
														<button class="btn btn-xs btn-primary"
																onclick="window.location.href='/cust/goods/add?good_id=14886110'">
															<i class="icon-edit bigger-120"></i>
														</button>

														<button class="btn btn-xs btn-danger"
																onclick="trashGood('14886110','0')">
									...
									<div class="row">
										...
										<div class="col-sm-6">
											<div class="sender" id="sample-table-2_info">
												共 ${goodsList.size()} 条记录，每页 5 条，共 1 页
											</div>
										</div>
										<div class="col-sm-6">
											<div class="dataTables_paginate paging_bootstrap sender">
												<ul class="pagination">
													...
													<li><a href="http://localhost:8080/fxmall/goods.do?m=queryGoodsByPage&page=1" class="active">1</a></li>
													<li><a href="http://localhost:8080/fxmall/goods.do?m=queryGoodsByPage&page=2">2</a></li>
													<li><a href="http://localhost:8080/fxmall/goods.do?m=queryGoodsByPage&page=3">3</a></li>
			...
			<a href="http://localhost:8081/cust/goods/list#" id="btn-scroll-up"
