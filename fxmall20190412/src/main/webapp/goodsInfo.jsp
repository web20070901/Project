	...
	<div class="main-container-inner">
		...
		<div class="main-content">
			...
			<div class="page-content">
				...
				<form method="post" name="copy_form" id="copy_form" action="./goods.do?m=addGoods">
					...
					<div class="widget-main">
						...
						<table class="table table-bordered table-striped">
							...
							<tr>
								...
								<td>
									<input type="text" id="order_no" name="order_no" value="${goods.orderNo}">
								</td>
							</tr>
							<tr>
								<td align="right"><span class="red">*</span><strong>购买作弊值：</strong></td>
								<td>
									<input type="text" id="sell_num" name="sell_num" value="${goods.sellNum}">
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
                                    <textarea id="promote_desc" name="promote_desc"
											  style="width:540px; height: 160px;">${goods.promoteDesc}</textarea>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
                                    <textarea id="copy_desc" name="copy_desc"
											  style="width:540px; height:80px;">${goods.copyDesc}</textarea>
								</td>
							</tr>
							...
							<tr>
								<td colspan="2" align="center">
									...
									<!--<input type="submit" class="btn btn-lxg btn-primary" value="保存"/>-->
...
<div>
	<div id="maskLevel" style="position:absolute;top:0;left:0;display:none;text-align:center;z-index:10000;">
